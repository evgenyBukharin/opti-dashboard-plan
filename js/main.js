/******/ (() => {
	...
	const VERSION = "1.6.2"; // CONCATENATED MODULE: ./node_modules/axios/lib/helpers/validator.js
	const validators = {};
	...
	/* harmony default export */ const lib_axios = axios; // CONCATENATED MODULE: ./src/js/components/dashboard-content.js
	...
	lib_axios
		...
		.catch((e) => {
			console.log(e);
		}); // CONCATENATED MODULE: ./src/js/components/custom-selects.js
	const custom_selects_months = [
		"Январь",
		"Февраль",
		"Март",
		"Апрель",
	...
	const custom_selects_quarters = ["I", "II", "III", "IV"];
	...
	function custom_selects_init(mode) {
		switch (mode) {
			case "month":
				if (isDetailedSelectHidden) {
					showDetailedSelect();
				}
				redrawItems(custom_selects_months, detailedSelect);
			...
			case "quarter":
				...
				redrawItems(custom_selects_quarters, detailedSelect);
				changeValue(detailedSelect, {
					value: "I квартал",
					text: "I",
				});
